...
public final class UserItemBinding implements ViewBinding {
  ...
  private UserItemBinding(@NonNull CardView rootView, @NonNull TextView country,
      @NonNull TextView doses, @NonNull TextView manufacturer, @NonNull ImageView photo) {
  ...
  public static UserItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.doses;
      TextView doses = ViewBindings.findChildViewById(rootView, id);
      if (doses == null) {
        break missingId;
      }
      ...
      return new UserItemBinding((CardView) rootView, country, doses, manufacturer, photo);
    }
